...
class LogistikKeluarModel extends Model
{
    ...
    protected $allowedFields    = ['id_barang', 'no_berita_acara', 'tgl_keluar', 'pihak_pertama', 'pihak_kedua', 'vol_unit'];

    public function getLogistikKeluar()
    {
        return $this->db->table('logistik_keluar')
            ->select('logistik_keluar.id, no_berita_acara, persediaan.nama_barang ,tgl_keluar, pihak_pertama, pihak_kedua, logistik_keluar.vol_unit, satuan, keterangan')
    ...
    {
        return $this->db->table('logistik_keluar')
            ->select('logistik_keluar.id, id_barang, no_berita_acara, persediaan.nama_barang ,tgl_keluar, pihak_pertama, pihak_kedua, logistik_keluar.vol_unit, satuan, keterangan')
            ->join('persediaan', 'persediaan.id=logistik_keluar.id_barang')
