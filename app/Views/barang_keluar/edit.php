                            ...
                            <div class="offset-md-3 col-md-6">
                                <form action="<?= site_url('admin/beritabarangkeluar/update/' . $barang_keluar->id); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('pihak_pertama')) ? 'is-invalid' : ''; ?>" value="<?= old('pihak_pertama', $barang_keluar->pihak_pertama); ?>" name="pihak_pertama" id="pihak_pertama">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('pihak_kedua')) ? 'is-invalid' : ''; ?>" value="<?= old('pihak_kedua', $barang_keluar->pihak_kedua); ?>" name="pihak_kedua" id="pihak_kedua">
                                        <div class="invalid-feedback">
