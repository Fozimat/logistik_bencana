                            ...
                            <div class="offset-md-3 col-md-6">
                                <form action="<?= site_url('admin/logistikmasuk/update/' . $logistik_masuk->id); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('pihak_pertama')) ? 'is-invalid' : ''; ?>" value="<?= old('pihak_pertama', $logistik_masuk->pihak_pertama); ?>" name="pihak_pertama" id="pihak_pertama">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('pihak_kedua')) ? 'is-invalid' : ''; ?>" value="<?= old('pihak_kedua', $logistik_masuk->pihak_kedua); ?>" name="pihak_kedua" id="pihak_kedua">
                                        <div class="invalid-feedback">
