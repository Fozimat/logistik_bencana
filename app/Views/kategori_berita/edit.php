            ...
            <div class="card-body">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 bg-primary d-flex justify-content-between align-items-center">
                        <h5 class="m-0 font-weight-bold text-light">Form Edit Kategori Berita
                        </h5>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="offset-md-3 col-md-6">
                                <form action="<?= site_url('admin/kategoriberita/update/' . $kategori_berita->id); ?>" method="POST">
                                    <?= csrf_field(); ?>
                                    <div class="form-group">
                                        <label for="kategori" class="hitam-tebal">Nama Kategori</label>
                                        <input type="text" class="form-control<?= ($validation->hasError('kategori')) ? 'is-invalid' : ''; ?>" value="<?= old('kategori', $kategori_berita->kategori); ?>" name="kategori" id="kategori">
