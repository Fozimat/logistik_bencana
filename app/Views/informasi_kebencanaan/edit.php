                            ...
                            <div class="offset-md-2 col-md-8">
                                <form action="<?= site_url('admin/informasikebencanaan/update/' . $informasi_kebencanaan->id); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('objek_terdampak')) ? 'is-invalid' : ''; ?>" value="<?= old('objek_terdampak', $informasi_kebencanaan->objek_terdampak); ?>" name="objek_terdampak" id="objek_terdampak">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control <?= ($validation->hasError('jumlah_korban_terdampak_laki')) ? 'is-invalid' : ''; ?>" value="<?= old('jumlah_korban_terdampak_laki', $informasi_kebencanaan->jumlah_korban_terdampak_laki); ?>" name="jumlah_korban_terdampak_laki" id="jumlah_korban_terdampak_laki">
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control <?= ($validation->hasError('jumlah_korban_terdampak_perempuan')) ? 'is-invalid' : ''; ?>" value="<?= old('jumlah_korban_terdampak_perempuan', $informasi_kebencanaan->jumlah_korban_terdampak_perempuan); ?>" name="jumlah_korban_terdampak_perempuan" id="jumlah_korban_terdampak_perempuan">
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control <?= ($validation->hasError('tindakan')) ? 'is-invalid' : ''; ?>" value="<?= old('tindakan', $informasi_kebencanaan->tindakan); ?>" name="tindakan" id="tindakan">
                                        <div class="invalid-feedback">
